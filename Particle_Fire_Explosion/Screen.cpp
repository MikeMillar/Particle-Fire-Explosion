...
namespace sf {
	...
	bool Screen::init() {
		...
		m_buffer2 = new Uint32[SCREEN_WIDTH * SCREEN_HEIGHT]; // Allocate memory for all pixels in program
	...
	void Screen::boxBlur() {
		// Swap buffers, so pixel info is in buffer2, and drawing to buffer1
